...
print(c)
print(encrypt(decrypt(encrypt(m, intersection[0][0]), intersection[0][1]), intersection[0][0]))
print(encrypt(decrypt(encrypt(m, intersection[1][0]), intersection[1][1]), intersection[1][0]))
